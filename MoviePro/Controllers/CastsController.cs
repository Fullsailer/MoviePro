...
namespace MoviePro.Controllers
{
    public class CastsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MovieId,CastID,Department,Name,Character,Profile,ContentType")] Cast cast)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MovieId,CastID,Department,Name,Character,Profile,ContentType")] Cast cast)
        {
            if (id != cast.Id)
            {
                return NotFound();
